...
function initialize () {
  ...
  if (responseCode == 204) {
    ...
    sheet.appendRow(["Background Image Urls", "http://ghostgames.com/wp-content/uploads/2012/10/ea-gaming.jpg", "/images/GreaterWidthRatioScaleUp.png", "http://www.spektyr.com/PrintImages/Cerulean%20Cross%203%20Large.jpg"]);
    ...
    sheet.appendRow(["Message Header Text", "<font color=#ffc000>URL IS/IT provides professional services to companies deploying the ever expanding portfolio Google&#8482; information technologies.</font>", "Five URLeD™ lamp only $80 save $20", "", ""]);
    sheet.appendRow(["Message Body Text", "Our consulting engineers have an excellent understanding of the Google&#8482; technologies and APIs which form the foundation of Google Apps&#8482; based solutions as well as extensive industry experience in all phases of the software development life cycle. We focus on the technical aspects of the challenges your team faces so you're free to concentrate on what's really important, your business.", "", ""]);
    sheet.appendRow(["Message Information Item", "URLeCycle", "none", "", ""]);
    sheet.appendRow(["Message Html Color Code", "#cccccc", "#cccccc", "", ""]);
    sheet.appendRow(["Message Width Percent Of Page", "0.5", "0.05", "", ""]);
    sheet.appendRow(["Message Percent Of Page From Left", "0.2", "0.2", "", ""]);
    ...
    sheet.appendRow(["Main Menu Selection Html"]);
    sheet.appendRow(["Main Menu Selected Html"]);
    sheet.appendRow(["Background Image Urls", "http://1.bp.blogspot.com/-bUHNHDSf7bU/UBKX1n88NgI/AAAAAAAABbw/0OxkyLT9gGo/s1600/BlackandWhiteNightBridge-long+goodbye.png", "/images/GreaterWidthRatioScaleUp.png", "http://www.spektyr.com/PrintImages/Cerulean%20Cross%203%20Large.jpg"]);
    sheet.appendRow(["Background Image Duration Seconds", "5", "5", "5"]);
    sheet.appendRow(["Content Menu Item Name", "Solid State Lighting", "", "", ""]);
    sheet.appendRow(["Content Menu Item Link", "http://sites.google.com/site/solidstatelamps/", "", "", ""]);
    sheet.appendRow(["Content Menu Style Sheet", "", "", "", ""]);
    ...
    sheet.appendRow(["Content Right Sidebar", "", "", "", ""]);
    sheet.appendRow(["Content Footer", "<span style=\"font-size:24px\">Introducing the UR<font color=\"#00ff00\">LeD</font>&trade; 100,000 hour solid state A19 lamp from <span style=\"font-family:Aldrich,arial,sans-serif;font-style:italic;font-weight:normal\"><font color=\"#ffffff\">The</font><font color=\"#00ff00\">Green</font><font color=\"#ffffff\">URL</font></span><sup><font color=\"#ffffff\" size=\"2\">&reg;</font></sup></span>", "", "", ""]);
    sheet.appendRow(["Message Header Text", "<font color=#ff0000>The easiest way to create a beautiful enterprise class web application</font>", "Five URLeD™ lamp only $80 save $20", "", ""]);
